...
export default function ProductDetail() {
  ...
  const { data: productsData } = useQuery({
    ...
    queryFn: () => {
      productApi.getProducts(queryConfig as ProductListConfig)
    },
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    //cach 1 : lay offsetx offsety don gian khi xu li dc bubble event
    const { offsetX, offsetY } = event.nativeEvent

    //cach 2: lay offsetx offsety khi cta k xu lis dc bubble event
      ...
      <div className='container'>
        <div className='mt-8 bg-white p-4 shadow'>
          ...
          <div className='mx-4 mt-12 mb-4 text-sm loading-loose'>
            {/* Đoạn này cài thêm 2 thư viện để loại bỏ chạy js trong chuỗi string dompurify và @types/dompurify */}
            <div
